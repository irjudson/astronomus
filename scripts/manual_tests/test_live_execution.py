...
Make sure your telescope is:
- Powered on and connected to network
- Accessible at seestar.local (or provide custom host)
- In a safe state to receive commands
"""
...
TELESCOPE_HOST = "seestar.local"  # Change if needed
...
def execute_target(plan: Dict[str, Any], target_index: int = 0) -> Optional[str]:
    ...
    print_warning(f"This will move your telescope to {target['target']['name']} and start imaging!")
...
def main():
    """Run the live execution test."""
    print_banner("Astro Planner - Live Telescope Execution Test")

    print("⚠️  IMPORTANT:")
    print("   This will actually control your telescope!")
